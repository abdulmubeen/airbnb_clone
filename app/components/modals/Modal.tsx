...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <>
      <div className="justify-center items-center flex overflow-x-hidden overflow-scroll overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/70">
          ...
          >
            <div className="translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg realtive flex flex-col w-full bg-white outline-none focus:outline-none">
              ...
              <div className="flex items-center p-6 rounded-t justify-center realtive border-b-[1px]">
                <button
                  className="p-1 border-0 hover:opacity-70 hover:bg-rose-50 rounded-full transition absolute left-9"
                  onClick={handleClose}
                >
                  <IoMdClose size={18} />
                </button>
